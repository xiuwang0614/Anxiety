...
% inputDir = 'E:\LDA\3';k =3;nRuns = 100;
% inputDir = 'E:\LDA\2';k =2;nRuns = 100;
% inputDir = 'E:\LDA\4';k =4;nRuns = 100;
% outputDir = 'E:\LDA\4\output';
[corrRuns, ~, I] = CBIG_ASDf_computeCorrBetweenRuns(inputDir, k); 

%% Final estimate we obtained
r_final = num2str(I(1));
fprintf('Final estimate for K = %d: run %s.\n', k, r_final);
mkdir(fullfile(outputDir, ['k' k], ['r' r_final]));
%mkdir(fullfile(outputDir, ['k2'], ['r5']));
...
% gamma_file = fullfile(inputDir, 'final.gamma');
% output_name = fullfile(outputDir, 'factorComp.txt');
