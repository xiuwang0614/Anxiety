...
corrMat_anx = load("E:\4LDA\LDA_anx\corr_Mat\Shaefer300\ANX_corr_Mat.mat");
corrMat_anx = corrMat_anx.combinedMatrix_A;
corrMat_Con = load("F:\4LDA\LDA_anx\corr_Mat\Shaefer300\HC_corr_Mat.mat");
corrMat_Con = corrMat_Con.combinedMatrix;
corrmat_all = cat(3,corrMat_anx,corrMat_Con);
sub_info_file = readtable("D:\Desktop\work\LDA\Demo_anxiety\sub_info_file_2.csv");
...
output_dir ='F:\4LDA\LDA_anx\corr_Mat\Shaefer300\input';
