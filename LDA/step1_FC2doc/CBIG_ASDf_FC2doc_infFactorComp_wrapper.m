...
corrMat_anx = load("F:\4LDA\LDA_anx\FC\infer\corrMat_Anx2.mat");
corrMat_anx = corrMat_anx.combinedMatrix;
corrMat_Con = load("F:\4LDA\LDA_anx\FC\estimate\corrMat_HC.mat");
corrMat_Con = corrMat_Con.combinedMatrix;
corrmat_all = cat(3,corrMat_anx,corrMat_Con);
sub_info_file = readtable("D:\Desktop\Demo_anxiety\sub_info_file_infer_2组.csv");
...
[id_site] =  CBIG_ASDf_getSubData(sub_info_file);
...
output_name = 'step1_output_infer';
output_dir = 'F:\4LDA\LDA_anx\FC\input';
output_dir = [output_dir '\'];
reg_CN = load("F:\4LDA\LDA_anx\FC\input\step1_output_reg_CN_mean_std.mat");
reg_CN_mean = reg_CN.reg_CN_mean;
reg_CN_std = reg_CN.reg_CN_std;
